<%@ Page Language="C#"  enableEventValidation="false" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="demo" %>
...
<%--          <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
          ...
          <div class="col-sm-6 col-md-4 col-lg-3 mb-4" style="margin-left:70%">
            <input type="submit" class="btn btn-primary btn-block form-control-same-height rounded-0" value="Tìm kiếm">
          </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-3 mb-lg-0">
            <div class="feature d-flex align-items-start" style="margin-left:20%">
              <span class="icon mr-3 flaticon-house"></span>
              <div class="text" >
                <h2 class="mt-0">Kênh nhà trọ giá rẻ</h2>
                <p>Rất phù hợp cho người sử dụng muốn tìm kiếm nhà trọ với mức giá phù hợp.</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-3 mb-lg-0">
            <div class="feature d-flex align-items-start">
              ...
              <div class="text">
                <h2 class="mt-0">Hãy đến với NHATROBINHDUONG </h2>
                <p>Chúng tôi luôn mong muốn đem lại hiệu quả tối đa cho khách hàng.</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-3 mb-lg-0">
            <div class="feature d-flex align-items-start">
              ...
              <div class="text">
                <h2 class="mt-0">Hấp dẫn, tiện lợi,tiết kiệm thời gian</h2>
                <p>Không ngại ngần hãy đến với kênh nhà trọ của chúng tôi, tráng đăng tin đáng tin cậy!</p>
              </div>
            </div>
          </div>
        </div>
