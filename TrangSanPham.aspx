<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TrangSanPham.aspx.cs" Inherits="TrangSanPham" %>
...
<%--                      <li class="has-children">
            ...
            <div id="fh5co-testimony-section">
                <div>
                    <div class="row">
                        <div class="col-md-12 col-offset-0 to-animate" style="text-align:center;">
                            <div class="wrap-testimony animate-box">
                                <asp:DataList ID="dlSanPham" runat="server" DataKeyField="MaSanPham"   >
                                    <ItemTemplate>
                                        &nbsp;<h2 style="letter-spacing:2px;font-weight:600;text-align:center;"><asp:Label ID="lbtensp" runat="server" Text='<%# Eval("TenSanPham") %>' /></h2>
                                        <br />
                                        <asp:Image ID="imgsp" runat="server" ImageUrl='<%# Eval("HinhSanPham") %>' Height="500px" Width="800px" />
                                        <br />
                                                                                
                                        &nbsp;<h2 style="letter-spacing:2px;font-weight:600;text-align:center;">
                                            <asp:Label ID="Label2" runat="server" Text="GIÁ:"></asp:Label>
                                            <asp:Label ID="lbgiasp" runat="server" Text='<%# Eval("GiaSanPham","{0:0,00}") %>'/>
                                            <asp:Label ID="Label1" runat="server" Text="đ"></asp:Label>
                                              </h2>
                                        <h2>
                                            <asp:Label ID="lbmasp" runat="server" Text='<%# Eval("MaSanPham") %>' Visible="false"></asp:Label>
                                        </h2>
                                        <br />
                                        <%--<p>
                                                    <a><asp:HyperLink ID="HyperLink1" runat="server" Text="ĐẶT HÀNG " CssClass="btn btn-primary btn-outline btn-lg"  NavigateUrl='<%# "~/GioHang.aspx?hc="+Eval("MaSanPham") %>'  ></asp:HyperLink></a>
                                                    <a><asp:HyperLink ID="HyperLink2" runat="server" Text="QUAY LẠI " CssClass="btn btn-primary btn-outline btn-lg" NavigateUrl="~/trangchu.aspx"  ></asp:HyperLink></a>
                                                    
                                        </p>--%>
                                        <br />
                                        <div class="item">
                                             <div class="testimony-slide active text-center">
                                                <div class="thongtin" style="margin-bottom:100px;">
                                                    <p style="font-size:23px;color:#0d0d0d;margin-left:-400px;font-weight:bold"><label>Thông tin chung:</label></p>
                                                    <ul style="width:800px;text-align:left;margin-left:100px">
                                                        <li class="chitiet"><asp:Label ID="lbthongtin1" runat="server" Text='<%# Bind("thongtin1") %>'></asp:Label></li>
                                                        <li class="chitiet"><asp:Label ID="lbthongtin2" runat="server" Text='<%# Bind("thongtin2") %>'></asp:Label></li>
                                                        <li class="chitiet"><asp:Label ID="lbthongtin3" runat="server" Text='<%# Bind("thongtin3") %>'></asp:Label></li>
                                                        <li class="chitiet"><asp:Label ID="lbthongtin4" runat="server" Text='<%# Bind("thongtin4") %>'></asp:Label></li>
                                                    </ul>
                                                </div>
                                             </div>
                                        </div>
