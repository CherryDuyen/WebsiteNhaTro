<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TrangPhuGiao.aspx.cs" Inherits="TrangPhuGiao" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Trang Phú Giáo</title>
...
<%--            <a href="TrangDangNhap.aspx" class="mr-3"><span class=""></span><b>ĐĂNG NHẬP</b></a>&nbsp;&nbsp;&nbsp;
            ...
            <a><asp:LinkButton runat="server" ID="btndangnhap" PostBackUrl="~/TrangDangKy.aspx" Text="Đăng nhập"></asp:LinkButton></a></span>
