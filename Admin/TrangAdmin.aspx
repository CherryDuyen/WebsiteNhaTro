<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TrangAdmin.aspx.cs" Inherits="Admin_TrangAdmin" %>
...
<%--        <asp:Button ID="Button1" CssClass="buttan" runat="server" Text="Quản lý chi tiết giỏ hàng" PostBackUrl="~/admin/quanlychitietgiohang.aspx" />
        &nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button2" CssClass="buttan" runat="server" Text="Quản lý đơn hàng" PostBackUrl="~/admin/quanlydonhang.aspx" />--%>
        &nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button3" CssClass="buttan" runat="server" Text="Quản lý sản phẩm" PostBackUrl="~/Admin/TrangQuanLySanPham.aspx" />
        &nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button4" CssClass="buttan" runat="server" Text="Quản lý tài khoản" PostBackUrl="~/Admin/TrangQuanLyTaiKhoan.aspx" />
    </div>
